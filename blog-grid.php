...
<html lang="en">
    ...
    <!-- Mobile Menu-->
                    ...
                    <div class="sub-header-content">
                        ...
                        <div class="col-md-6 subpage-nav">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="http://localhost/charitus/index.php/blog-grid/">Blog</a></li>
        ...
        |========================
        -->
        <section class="section ch-blog blog-grid" id="ch-blog">
            <div class="container">
                <div class="row section-separator">
                    <div class="each-blog wow fadeIn" data-wow-delay="0.2s">
                                ...
                                <div class="blog-inner item shadow">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        Sed diam metus, facilisis eu.</p>
                                         <a href="http://localhost/charitus/index.php/blog-single/" class="btn btn-border"> Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
