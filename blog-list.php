...
<html lang="en">
    ...
    <!-- Mobile Menu-->
                    ...
                    <div class="sub-header-content">
                        ...
                        <div class="col-md-6 subpage-nav">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="http://localhost/charitus/index.php/causes-grid/">Blog</a></li>
        ...
        |========================
        -->
        <section class="section ch-blog blog-list" id="ch-blog">
            <div class="container">
                <div class="row section-separator">
                    <div class="each-blog col-md-8 col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 ">
                                <div class="blog-inner item shadow">
                                    <div class="blog-banner">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/images/crw.jpg" alt="" class="img-responsive">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        Sed diam metus, facilisis eu.</p>
                                         <a href=" http://localhost/charitus/index.php/causes-single-page/" class="btn btn-border"> Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 ">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <div class="blog-inner item shadow">
                                    <div class="blog-banner">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/images/hand.jpg" alt="" class="img-responsive">
                                        <span class="date">07 jan</span>
                                    </div>
                                    <div class="blog-content">
                    ...
                    <aside class="col-md-4 col-sm-6 ch-sidebar">
                        <div class="ch-popular-post shadow ch-sidebar-widget wow fadeInRight" data-wow-delay="0.3s">
                            <h4>Popular post</h4>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <div class="widget-img col-md-4 col-xs-4 padding-left-o">
                                        <img src="<?php echo get_template_directory_uri();?>/assets/images/b.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="ch-widget-details col-md-8 col-xs-8 padding-left-o">
                                        <a href=""><h4>charity for this sum</h4></a>
                                        <span>Feb 19, 2017</span>
                        ...
                        <div class="ch-urgent-causes ch-causes shadow ch-sidebar-widget wow fadeInRight" data-wow-delay="0.5s">
                            <h4>Urgent Causes</h4>
