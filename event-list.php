        ...
        <section class="section ch-event ch-donation-event-list" id="ch-event">
            <div class="container">
                <div class="row section-separator">
                    <div class="each-causes">
                        <div class="col-md-12 col-sm-12 ch-event-list-item">
                            <div class="row">
                                <div class="event-inner item shadow bg-3 overflow">
                                    <div class="col-md-6 padding-o">
                                        <div class="event-banner">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/images/e.jpg" alt="" class="img-responsive">
                                    ...
                                    <div class="col-md-6">
                                        <div class="event-content">
                                            ...
                                            <p>Phasellus et diam nec massa lortis venenatis. Nullam varus enimos aet eros 
                                            ullaorper semper. Sed diaim metus, facilisis eu. Phasellus epecet diam nec 
                                            massa lortis venenatis. Nullam varius enim at eros ullaorper semper. Sed 
                                            diam metus, facilisis eu. Phasellus epet diam nec massa.</p>
                        ...
                        <div class="col-md-12 col-sm-12 ch-event-list-item">
                            <div class="row">
                                <div class="event-inner item shadow bg-3 overflow">
                                    <div class="col-md-6 padding-o">
                                        <div class="event-banner">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/images/eg.jpg" alt="" class="img-responsive">
                                            <span class="date">07 jan</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="event-content">
                                            <h4>Concert for Smile </h4>
                                            <div class="schedule">
                                                <span class="event-time"><i class="fa fa-clock-o main-color"></i> 10:00 am - 11:00am</span>
                                                <span class="event-place"><i class="fa fa-map-marker main-color"></i> los angeles</span>
                                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 ch-event-list-item">
                            <div class="row">
                                <div class="event-inner item shadow bg-3 overflow">
                                    <div class="col-md-6 padding-o">
                                        <div class="event-banner">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/images/eg1.jpg" alt="" class="img-responsive">
                                            <span class="date">07 jan</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="col-md-12 col-sm-12 ch-event-list-item">
                            <div class="row">
                                <div class="event-inner item shadow bg-3 overflow">
                                    <div class="col-md-6 padding-o">
                                        <div class="event-banner">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/images/eg2.jpg" alt="" class="img-responsive">
                                            <span class="date">07 jan</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="col-md-12 col-sm-12 ch-event-list-item">
                            <div class="row">
                                <div class="event-inner item shadow bg-3 overflow">
                                    <div class="col-md-6 padding-o">
                                        <div class="event-banner">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/images/eg5.jpg" alt="" class="img-responsive">
                                            <span class="date">07 jan</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
